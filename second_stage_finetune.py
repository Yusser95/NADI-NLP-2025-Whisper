...
for i in range(0,len(dialects)):
    ...
    wandb.init(project="my-whisper-fine-tuning", name=f"whisper-dialect-{'_'.join(train_languages)}-ft-second-stage-tuning-cer")
    ...
    for l in train_languages:
        print(l)
        # for example, the "Yemen" portion of the dataset
    ...
    training_args = Seq2SeqTrainingArguments(
        output_dir=os.path.join(base_dir, f"tests/badr/whisper-dialect-{'_'.join(train_languages)}-ft-second-stage-tuning-cer"),  # change to a repo name of your choice
